...
const Hero = ({ themeMode = 'light', className, ...rest }) => {
  ...
  const subtitle =
    "Philanthropy Finance wants to create a healthier financial ecosystem. One where the profits are shared equally and used for charity activities. As joy is also a part of life it’s obvious that we'd like to integrate it as well!";
